...
| `notifications.defaultArgs.enableLeaderElection`                             | Enable leader election                                                                                             | `false`        |
| `notifications.defaultArgs.policy`                                           | Default policy                                                                                                     | `sync`         |
| `notifications.defaultArgs.debug`                                            | Enable debug mode                                                                                                  | `false`        |
| `notifications.defaultArgs.dryRun`                                           | Enable dry-run mode                                                                                                | `false`        |
| `notifications.args`                                                         | Override default container args (useful when using custom images). Overrides the defaultArgs.                      | `[]`           |
...
| `notifications.bots.slack.args`                                              | Override default container args (useful when using custom images). Overrides the defaultArgs.                      | `[]`           |
